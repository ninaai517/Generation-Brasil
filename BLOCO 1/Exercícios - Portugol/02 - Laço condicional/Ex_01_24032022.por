...
//Caso contrário mostrar tais variáveis com o conteúdo ZERO.	
	...
	funcao inicio()
	{
		real P //peso de tomate
		real E //excesso de pes (se ultrapassar 50 kgs, multa)
		real M //multa a kg excedido 

		escreva("Kgs de tomate: ")
		leia(P)
		...
		se(P>50){
			escreva("\nPeso de tomate (kg): ", P, "\nPeso excedente (kg): ", E)
			escreva("\nVocê deverá pagar uma multa de: R$ " + M + "\n")
			}
		senao se (P<=50){
			E = 0.00 
			M = 0.00
			escreva("\nPeso dentro do regulamento estabelecido pelo Estado de São Paulo\n")
			escreva ("Excesso: ", E, "\nMulta: R$: ", M, "\n")
			}
